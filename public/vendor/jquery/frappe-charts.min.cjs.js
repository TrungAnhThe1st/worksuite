...
function heatSquare(t, e, n, i, a) {
    var r =
        ...
        s = { className: t, x: e, y: n, width: i, height: i, rx: a, fill: r };
    return (
...
function legendBar(t, e, n) {
    ...
    var r = {
        ...
        s = createSVG("g", { transform: "translate(" + t + ", " + e + ")" });
...
function makeVertLine(t, e, n, i) {
    ...
    var r = createSVG("line", {
        ...
        s = createSVG("g", { transform: "translate(" + t + ", 0)" });
...
function makeHoriLine(t, e, n, i) {
    ...
    return (
        (0 !== o && "0" !== o) || (s.style.stroke = "rgba(27, 31, 35, 0.6)"),
        s.appendChild(r),
        s.appendChild(o),
        s
    );
...
function datasetBar(t, e, n, i) {
    var a = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : "",
        ...
        h = u[1];
    (h -= o),
        0 === c && ((c = s.minHeight), (h -= s.minHeight)),
        isValidNumber(t) || (t = 0),
        isValidNumber(h) || (h = 0),
        isValidNumber(c, !0) || (c = 0),
        isValidNumber(n, !0) || (n = 0);
...
function animatePath(t, e, n, i, a) {
    ...
    var s = [t.path, { d: "M" + o }, PATH_ANIM_DUR, STD_EASING];
    if ((r.push(s), t.region)) {
        var l = e[0] + "," + i + "L",
            u = "L" + e.slice(-1)[0] + ", " + i,
            c = [t.region, { d: "M" + l + o + u }, PATH_ANIM_DUR, STD_EASING];
        r.push(c);
    }
    return r;
}
...
function animateSVG(t, e) {
    ...
    e.map(function (t) {
        ...
        (r = l[0]), (o = l[1]), n.push(o), i.push([r, a]), a.replaceChild(r, e);
    });
    var a = t.cloneNode(!0);
    return (
        i.map(function (t, i) {
...
function getComponent(t, e, n) {
    ...
    return (
        Object.assign(a, { constants: e, getData: n }), new ChartComponent(a)
    );
}
...
function calcChartIntervals(t) {
    ...
    if (i >= 0 && a >= 0)
        normalize(i)[1],
            (r = n ? getChartIntervals(i, a) : getChartIntervals(i));
    else if (i > 0 && a < 0) {
        var o = Math.abs(a);
        i >= o
            ? (normalize(i)[1], (r = e(i, o)))
            : (normalize(o)[1],
              (r = e(o, i)
                  .reverse()
                  .map(function (t) {
        ...
        var s = Math.abs(a),
            l = Math.abs(i);
        normalize(s)[1],
            (r = (r = n ? getChartIntervals(s, l) : getChartIntervals(s))
                .reverse()
                .map(function (t) {
                    return -1 * t;
                }));
...
function dataPrep(t, e) {
    ...
    return (
        ...
        i.map(function (t) {
            ...
            t.chartType ||
                (AXIS_DATASET_CHART_TYPES.includes(e), (t.chartType = e));
        }),
        t.yRegions &&
...
var BASE_MEASURES = {
            ...
            _createClass$2(t, [
                ...
                },
                {
                    ...
                    value: function (t, e) {
                        var n = [];
                        return (
                            (t = (t || []).concat(DEFAULT_COLORS[e])).forEach(
                                function (t) {
                                    var e = getColor(t);
                                    isValidColor(e)
                                        ? n.push(e)
                ...
                { key: "calc", value: function () {} },
                {
                    ...
                    value: function () {
                        (this.baseWidth = getElementContentWidth(this.parent)),
                            (this.width =
                                this.baseWidth - getExtraWidth(this.measures));
                    },
                },
                {
                    key: "makeChartArea",
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        this.legendTotals.map(function (a, r) {
                            var o = 150,
                                s = Math.floor(
                                    (t.width - getExtraWidth(t.measures)) / o
                                );
                            t.legendTotals.length < s &&
                                (o = t.width / t.legendTotals.length),
                                n > s && ((n = 0), (i += 20));
                            var l = o * n + 5,
                                u = t.config.truncateLegends
                                    ? truncateString(e.labels[r], o / 10)
                                    : e.labels[r],
            ...
            _createClass$4(t, [
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        var e = [];
                        return (
                            t && (e = this.animateElements(this.data) || []), e
                        );
                    },
                },
            ]),
    ...
    componentConfigs = {
        ...
        barGraph: {
            layerClass: function () {
                return (
                    "dataset-units dataset-bars dataset-" + this.constants.index
                );
            },
            makeElements: function (t) {
        ...
        lineGraph: {
            layerClass: function () {
                return (
                    "dataset-units dataset-line dataset-" + this.constants.index
                );
            },
            makeElements: function (t) {
                var e = this.constants;
                    ...
                    value: function (t) {
                        var e = this.radius,
                            ...
                            i = getPositionByAngle(
                                t.startAngle + t.angle / 2,
                                e
                            );
                        return (
                            "translate3d(" + i.x * n + "px," + i.y * n + "px,0)"
                        );
                    },
                },
                {
            ...
            _createClass$6(e, [
                    ...
                    value: function () {
                        var t = this.discreteDomains ? NO_OF_YEAR_MONTHS : 0,
                            e = this.state.noOfWeeks
                                ...
                                : 52;
                        this.baseWidth =
                            (e + t) * COL_WIDTH + getExtraWidth(this.measures);
                    },
                },
                {
                    key: "prepareData",
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        this.components = new Map(
                            i.map(function (t, e) {
                                var n = getComponent.apply(
                                    void 0,
                                    _toConsumableArray$3(t)
                                );
                                return [t[0] + "-" + e, n];
                            })
                        );
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        var r = makeText(
                            "subdomain-name",
                            e +
                                HEATMAP_DISTRIBUTION_SIZE * (COL_WIDTH + 3) +
                                COL_WIDTH / 4,
                            n,
                            "More",
                ...
                },
                {
                    ...
                    value: function () {
                        for (
                            ...
                            o.push(this.getDomainConfig(s, u)),
                                addDays(u, 1),
                                (s = u);
                        }
                        return o;
                    ...
                    value: function (t) {
                        ...
                        for (
                            ...
                            (u = this.getCol(r, i)),
                                ...
                                addDays(
                                    (r = new Date(
                                        u[NO_OF_DAYS_IN_WEEK - 1].yyyyMmDd
                                    )),
                                    1
                                );
                        return (
                    ...
                    value: function (t, e) {
                        for (
                            var n =
                                ...
                                r = [],
                                o = 0;
                            o < NO_OF_DAYS_IN_WEEK;
                            o++, addDays(a, 1)
                        ) {
                            var s = {},
                                l = a >= i.start && a <= i.end;
                            n || a.getMonth() !== e || !l
                                ? (s.yyyyMmDd = getYyyyMmDd(a))
                                : (s = this.getSubDomainConfig(a)),
                                r.push(s);
                        }
                        return r;
                    },
                },
                {
                    ...
                    value: function (t) {
                        ...
                        return {
                            ...
                            dataValue: n || 0,
                            fill: this.colors[
                                getMaxCheckpoint(n, this.state.distribution)
                            ],
                        };
                    },
                },
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        this.data.yMarkers &&
                            ...
                            this.data.yRegions &&
                                (this.state.yRegions = this.data.yRegions.map(
                                    function (e) {
                                        return (
                                            (e.startPos = scale(
                                                e.start,
                            ...
                            a = n.map(function (e) {
                                ...
                                return [
                                    ...
                                    function () {
                                        ...
                                        return (
                                            a &&
                                                (c = e.yPositions.map(function (
                                                    t,
                                                    n
                                                ) {
                                                    return (
                                                        t - e.cumulativeYPos[n]
                                                    );
                                                })),
                                            {
                                                xPositions: l,
                        ...
                        (this.dataUnitComponents = []),
                            (this.components = new Map(
                                e
                                    .filter(function (e) {
                                        return (
                                            !s.includes(e[0]) || t.state[e[0]]
                                        );
                                    })
                                    .map(function (e) {
                                        var n = getComponent.apply(
                                            void 0,
                                            _toConsumableArray$5(e)
                                        );
                                        return (
                ...
                },
                {
                    ...
                    value: function () {
                        ...
                        this.overlayGuides &&
                            ...
                            (this.overlayGuides = this.dataUnitComponents.map(
                                function (t) {
                                    return {
                                        type: t.unitType,
                                        overlay: void 0,
                        ...
                        if (t) {
                            ...
                            if (n) {
                                transform(
                                    ...
                                    (t.style.stroke = lightenDarkenColor(
                                        a,
                                        50
                                    ));
                                var r = getOffset(this.svg),
