        ...
        function (e, t, n) {
            ...
            function m(e, t, n) {
                ...
                ((r.disabled || r.readOnly) && t.respectDisabledReadOnly) ||
                    ((t.dateSelected = n
                        ? void 0
                        : new Date(t.currentYear, t.currentMonth, o)),
                            ...
                            if (s.noPosition && !l)
                                ...
                                if (i.contains("qs-num")) {
                                    ...
                                    return void (+x == +s.dateSelected
                                        ? m(a, s, !0)
                                        : a.classList.contains("qs-disabled") ||
                                          m(a, s));
                                }
            ...
            function O(e, t) {
                ...
                if (null == e)
                    return (
                        ...
                        p(this.el, this, !0),
                        o && (y({ instance: this, deselect: !0 }), u(o)),
                        u(this),
                        this
                    );
                if (!w(e))
                ...
                (this.dateSelected = n),
                    ...
                    p(this.el, this),
                    o && (y({ instance: this }), u(o));
                var i = r === n.getFullYear() && a === n.getMonth();
                return (
                    i || t ? u(this, n) : i || u(this, new Date(r, a, 1)), this
                );
            }
            function N(e) {
                return I(this, e, !0);
                ...
                if (null == t)
                    (e[d()] = void 0),
                        o
                            ? ((o[d()] = void 0),
                              n
                                  ? ((a && !r) || (!a && !o.dateSelected)) &&
                                    ((e.minDate = void 0), (o.minDate = void 0))
                                  : ((a && !o.dateSelected) || (!a && !r)) &&
                                    ((e.maxDate = void 0),
                                    (o.maxDate = void 0)))
                            : (e[h()] = void 0);
                else {
                    ...
                    o
                        ? (((a && n && l > (r || s)) ||
                              (a && !n && l < (o.dateSelected || i)) ||
                              (!a && n && l > (o.dateSelected || s)) ||
                              (!a && !n && l < (r || i))) &&
                              v(),
                          (e[d()] = l),
                          (o[d()] = l),
                          ((n && ((a && !r) || (!a && !o.dateSelected))) ||
                              (!n && ((a && !o.dateSelected) || (!a && !r)))) &&
                              ((e[h()] = l), (o[h()] = l)))
                        : (((n && l > (r || s)) || (!n && l < (r || i))) && v(),
                          (e[h()] = l));
                }
            ...
            function F(e, t) {
                ...
                if (!w(n))
                    throw new Error(
                        "`navigate` needs a JavaScript Date object."
                    );
                (this.currentYear = n.getFullYear()),
                    (this.currentMonth = n.getMonth()),
                    u(this),
            ...
            t.default = function (e, t) {
                var n = (function (e, t) {
                    ...
                    if ("string" == typeof u)
                        ...
                        for (
                            var h,
                                f = ("getRootNode" in window.Node.prototype),
                                v = u.parentNode;
                            !h;
                            ...
                            if ("[object HTMLDocument]" === m) h = !0;
                                ...
                                if (((h = !0), !f))
                                    throw new Error(
                                        "The shadow DOM is not supported in your browser."
                                    );
                                (n = v), (l = v.host);
                            } else v = v.parentNode;
                        }
                    ...
                    var E = {
                        ...
                        calendar: M,
                        currentMonth: (
                            c.startDate || c.dateSelected
                        ).getMonth(),
                        currentMonthName: (c.months || o)[
                        ...
                        overlayPlaceholder:
                            c.overlayPlaceholder || "4-digit year",
                ...
                return (
                    u(n, n.startDate || n.dateSelected), n.alwaysShow && b(n), n
                );
            };
        },
        function (e, t, n) {},
