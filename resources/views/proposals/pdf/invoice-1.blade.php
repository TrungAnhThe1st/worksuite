            ...
            <tbody>
                    ...
                    @if ($item->type == 'item')
                        <tr style="page-break-inside: avoid;">
                            ...
                            <td class="desc">
                                ...
                                <table>
                                    <tr>
                                        <td class="item-summary word-break border-top-0 border-right-0 border-left-0 border-bottom-0">{!! nl2br(strip_tags($item->item_summary)) !!}</td>
                                    </tr>
                                </table>
                                @endif
                ...
                @foreach ($taxes as $key => $tax)
                    <tr style="page-break-inside: avoid;" class="tax">
                        ...
                        <td class="unit">{{ currency_formatter($tax, 2, '') }}</td>
                    </tr>
                @endforeach
            </tbody>
            <tfoot>
