        ...
        <section id="items">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr class="amount-total">
                    ...
                    <td>
                        {{ currency_formatter($invoice->total, 2, '') }}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="text-right">
                        {{ currency_formatter($invoice->getPaidAmount(), 2,  '') }}
                    </td>
                </tr>
                <tr>
                    <td colspan="{{ $invoiceSetting->hsn_sac_code_show ? '5': '4' }}">
